...
Post.create(title: "Liverpool", content: "Gave the world The Beatles, something we'll always be grateful for!", city_id: london.id, user_id: user1.id, photo: "http://www.blogcdn.com/travel.aol.co.uk/media/2011/11/liv1.jpg")
